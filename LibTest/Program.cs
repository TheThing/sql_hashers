...
namespace LibTest
{
    ...
    {
        private static readonly byte[] _password = new byte[] {
        ...
        private static readonly byte[] _secret = new byte[] {
        ...
        private static readonly byte[] _ad = new byte[] { 0x4b, 0x53, 0x7c, 0xa5, 0xe0, 0x2b, 0xe4, 0x06, 0xce, 0x9e, 0x9e, 0xa3, 0x27, 0x9c, 0x6e, 0x26 };

        private static readonly byte[] _expected = new byte[]
        {
        ...
        {
            string hash = PasswordHasher.Argon2idHash(
                password: "Hello",
                salt: "qwerty12345",
                secret: null,
                associatedData: null,
